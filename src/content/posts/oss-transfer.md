...
※2026年9月追記 この記事のあと中古車店を始めて、自分が申請者になる移転登録は今もOSSでやっています。仕入れから販売までの手続きを台帳にした[トドロク](https://tk.doany.io/?from=blog-oss)を作りました。この記事に関係するのは2つで、車検証のQRをスマホで読むと後述の車検証情報取込みファイルを出せること、車庫証明を同時申請するときの所在図・配置図を地図の上で描けることです。該当の箇所に追記しています。
...
※2026年9月追記 閲覧アプリで出せる車検証情報取込みファイルは、[トドロク](https://tk.doany.io/?from=blog-oss)でも出せます。車検証のQRをスマホで読んで1台登録すると、車両情報の画面から同じ形式のJSONが落とせます。車検証を車に戻してしまったあとでも作れるので、自分はこちらを使っています。
...
下記から移転登録の申請をします。  
[移転登録](https://www.oss.mlit.go.jp/secure/tetsuduki/principal/shinsei/kyodaku-iten/index.html#)
