...
emoji: "🚫"
type: tech
topics: ["Slack","SlackAPI","OAuth","個人開発"]
published: true
...
## ワークスペース側の設定は思っていたのと逆だった

ここが一番の収穫でした。  
内部アプリなんてどうせ管理者に止められるのでは、と思っていたのですが前提が逆でした。
...
### 罠2: token rotationを有効にすると連携が切れる
...
初出: https://doany.io/posts/slack-search-read/
